        ...
        <div style={{ paddingBottom: '50px' }} className="lefts">
          ...
          <div className="subr">
            ...
            <div className="eqp">
              ...
              <p>
                    At SRKR Engineering College, our chemistry department boasts a wide range of modern equipment essential for comprehensive chemical analysis and experimentation. From high-performance liquid chromatography (HPLC) and gas chromatography (GC) to spectroscopy devices such as UV-Vis and FTIR, our facilities are equipped to meet the diverse needs of our curriculum. 
                </p><p className='p2'>
